...
class MemberController extends Controller
{
    ...
    public function index()
    {
        $user = Auth::user();
        $page = "Profile Anda";
        $member = Member::all()->where('user_id', Auth::user()->id);
        if ($member->isEmpty()) {
            return view('user.member.tambah', compact('user', 'page', 'member'));
        }
        return view('user.member.profile', compact('user', 'page', 'member'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('user.member.edit', compact('user', 'page', 'member', 'profile'));
    }
